...
PAGES.append(page(
    "11_helper_mew_games", "پنل هلپر", "inline bot",
    "🐱 <b>بازی‌های خودکار ربات میو</b>\n\nیک بازی را انتخاب کنید، سپس گروه‌های خودتان را برای اجرای خودکار انتخاب کنید.",
    [["🎣 ماهیگیری"],
     ["👨‍🍳 آشپزی"],
     ["🏭 کارخونه"],
     ["🐱 گرفتن گربه"],
     ...
     ["🛑 توقف همهٔ بازی‌ها"],
     ["🔙 بازگشت"]],
    ava="H", banner_text="🐱 بازی‌های خودکار میو"))

PAGES.append(page(
    "12_helper_mew_group_select", "پنل هلپر", "inline bot",
    "🏭 <b>کارخونه — بازی خودکار میو</b>\n\nگروهی را که با ربات میو بازی می‌کنید انتخاب کنید. "
    "سلف هر <b>۳۰ دقیقه</b> کلمهٔ «کارخونه» را در آن گروه می‌فرستد.\n✅ = فعال | ⬜️ = غیرفعال",
    [["➕", "⏱ هر ۳۰ دقیقه", "➖"],
     ["✅ 888"],
     ["✅ Self vtr"],
     ["⬜️ VOLCANO"],
     ...
     ["🔄 بروزرسانی گروه‌ها"],
     ["🔙 بازگشت"]],
    ava="H", banner_text="🏭 انتخاب گروه‌های شما"))
